---
title: Build một cái K-V Database đơn giản như thế nào?
summary: Hành trình tìm hiểu cách xây dựng một K-V Database đơn giản từ code thực tế
postLayout: column
date: '2025-08-30'
draft: false
...
Hi mọi người, chuyện là mình vừa xong đồ án tốt nghiệp và chỉ đang chờ ngày tốt nghiệp thôi nên cũng có kha khá thời gian rảnh đâm ra ngứa tay (lưu luyến sự bận bịu của đồ án tốt nghiệp chăng???).
Mò lại trong đống list note ngày xưa thì thấy là mình có đang thắc mắc rằng 1 cái Key-Value (K-V) Database thì nó được xây dựng chuẩn chỉ từ code như nào thay vì chỉ là lý thuyết (cái này chắc lưu lạc từ hồi mình mò vọc vạch Raft).
...
Thôi thì cũng rảnh mà, đọc xem thử giữa triển khai thực tế và lý thuyết nó có khác gì nhau không. Biết đâu sau này mình lại trở thành contributor với một thứ ma quỷ gì đó thì sao =))))
...
Mỗi thành phần mình sẽ thảo luận riêng thành 1 bài luôn cho dễ đọc, mọi người nhấn vào từng bài để đọc nhé

- [Database file format](https://scul0405.github.io/blog/build-a-kv-db-p1)
- [Storage and cache management](https://scul0405.github.io/blog/build-a-kv-db-p2)
- [Data structure](https://scul0405.github.io/blog/build-a-kv-db-p3)
- [Bucket System](https://scul0405.github.io/blog/build-a-kv-db-p4)
- [Cursor](https://scul0405.github.io/blog/build-a-kv-db-p5)
- [Transaction system](https://scul0405.github.io/blog/build-a-kv-db-p6)
- [DB Layer](https://scul0405.github.io/blog/build-a-kv-db-p7)
...
## Tham khảo
- [BoltDB - An embedded key/value database for Go - Ben Johnson](https://github.com/boltdb/bolt)
- [Lightning Memory-Mapped Database - Howard Chu](https://www.symas.com/symas-embedded-database-lmdb)
- [LMDB (The Databaseology Lectures - CMU Fall 2015) - Howard Chu](https://www.youtube.com/watch?v=tEa5sAh-kVk)
...
- [Learn Bolt - ZhengHe](https://github.com/ZhengHe-MD/learn-bolt)