...
Hàm `sdsResize` cũng sẽ được thực hiện với các quy trình khá tương tự. Ta chỉ cần biết quy trình nó diễn ra như nào, cấp phát,
thu hồi ra sao là được rồi.

Thế thôi, các method khác loằng ngoằng lắm, nếu có thời gian thì sẽ đọc và update sau hẹ hẹ.
