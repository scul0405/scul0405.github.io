...
Tuy nhiên, có một cái khá là độc đáo của phiên bản `dict` này là `rehashing`. Đây là một kĩ thuật cho phép việc expand và đọc
ghi diễn ra đồng thời. Cũng là thứ khó nhất khi triển khai `dict`. Chi tiết như nào thì tí sẽ biết.
...
- Với mỗi operation được client gọi dến, kiểm tra xem dict hiện tại
có đang nằm trong trạng thái rehashing hay không?
...
- Thực hiện rehash nếu trạng thái hiện tại đang là rehashing.
